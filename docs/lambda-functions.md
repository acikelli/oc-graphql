...
| ------------------------- | ------------ | ---------- | ----------- |
| CRUD Operations           | Node.js 18.x | 1024 MB    | 30 seconds  |
| SQL Queries               | Node.js 18.x | 1024 MB    | 5 minutes   |
| Task Mutations            | Node.js 18.x | 1024 MB    | 30 seconds  |
| Task Result Queries       | Node.js 18.x | 1024 MB    | 30 seconds  |
| Execution Tracker         | Node.js 18.x | 1024 MB    | 5 minutes   |
| Stream Processor          | Python 3.11  | 1024 MB    | 15 minutes  |
| Cascade Deletion Listener | Node.js 18.x | 1024 MB    | 15 minutes  |
| Deletion Listener         | Node.js 18.x | 1024 MB    | 15 minutes  |
