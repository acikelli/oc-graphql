...
│   │   │   ├── 123.parquet        # Individual records
│   │   │   ├── 456.parquet
│   │   │   └── 789.parquet
...
Examples:
- tables/user/year=2024/month=12/day=15/123.parquet
- tables/product/year=2024/month=12/day=15/456.parquet
```
...
Examples:
- tables/user_favorites/year=2024/month=12/day=15/4309-83e6-279f37ea0ded.parquet
- tables/post_tags/year=2024/month=12/day=15/bd9d0faf-6e8a.parquet
```
